// Comprehensive list of Indian States/UTs and their real districts.
// Tahsil/Block and Village/Town level data is NOT hardcoded here because
// India has 5,000+ tahsils and 6,00,000+ villages — far too large to ship
// inside a static frontend app. Instead, Tahsil and Village are simple
// free-text fields on the form/filter (candidate types them in) — this is
// what every real India-wide portal (Naukri, Apna, Quikr Jobs etc.) does
// in practice for hyperlocal address levels.
...
export const INDIA_DISTRICTS: Record<string, string[]> = {
  ...
  'Nagaland': ['Chumukedima', 'Dimapur', 'Kiphire', 'Kohima', 'Longleng', 'Mokokchung', 'Mon', 'Niuland', 'Noklak', 'Peren', 'Phek', 'Shamator', 'Tuensang', 'Wokha', 'Zunheboto'],
